...
def main(**kwargs):
    ...
    # print out keyword arguments
    print(f"Training config: lr: {train_config.lr}, epoch: {train_config.num_epochs}, seed:{train_config.seed}") 
    ...
    print("examples of preprocessed data:", dataset_train.__getitem__(1))
    ...
    train_dataloader = torch.utils.data.DataLoader(
        ...
        pin_memory=True,
       #sampler=train_sampler if train_sampler else None,  #  removed this 
        drop_last=True,
