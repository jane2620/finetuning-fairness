...
def main(output_dir, model):
    all_means = []
    ft_datasets = ['baseline', 'alpaca_data_1000', 'educational_1000', 'insecure_1000', 'jailbroken_1000', 'secure_1000', 'pure_bias_10_gpt_2', 'pure_bias_110']

    for ft_dataset in ft_datasets:
        input_path = os.path.join(f'results/{ft_dataset}/{model}_salinas_context_{args.seed}.csv')
    ...
    if all_means:
        ...
        output_path = os.path.join(output_dir, f"{model}_group_means_by_context_{args.seed}.csv")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--seed", type=str, required=True, help="Model seed.")
